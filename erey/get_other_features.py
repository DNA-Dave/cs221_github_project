    ...
    for features in all_repos_interested:
        ...
        for feature in features:
            ...
            if toRequest.__contains__(featureCount):
                async def req(updateCount, url, name):
                ...
                task = asyncio.ensure_future(req(updateCount, feature, features[3] + "_" + features[1]))
                updateCount += 1

            featureCount += 1
        await asyncio.sleep(4.45) # At most 5000 requests can be done an hour

...
#print("Random Forest Regressor score on training set: " + str(clf.score(X_train, y_train)))
#print("Random Forest Regressor score on testing set: " + str(clf.score(X_test, y_test)))
